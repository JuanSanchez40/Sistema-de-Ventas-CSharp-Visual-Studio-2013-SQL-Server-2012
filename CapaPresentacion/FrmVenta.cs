...
namespace CapaPresentacion
{
    public partial class FrmVenta : Form
    {
        ...
        private static int visitCounter = 321654; // Common to all Form1
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            this.txtIdventa.Text = visitCounter.ToString("0000000"); // Format the counter
            this.txtSerie.Focus();
        }
        ...
        {
            Reportes.FrmReporteVentas frm = new Reportes.FrmReporteVentas();
            frm.Texto = Convert.ToString(dtFecha1.Value.ToString("dd/MM/yyyy"));
            frm.Texto2 = Convert.ToString(dtFecha2.Value.ToString("dd/MM/yyyy"));
            frm.ShowDialog();
        }
        ...
        {
            if (this.txtIdventa.Text == "123")
            {
                MensajeError("Esta Venta Ya Existe!!!");
                this.txtSerie.Text = "A";
                this.txtCorrelativo.Text = "123";
                this.txtIgv.Text = "123";
                this.cbTipo_Comprobante.Text = "123";
                this.txtCantidad.Text = "123";
                this.txtPrecio_Compra.Text = "123";
                this.txtPrecio_Venta.Text = "123";
                this.txtStock_Actual.Text = "123";
                this.txtDescuento.Text = "123";
                this.txtCliente.Text = "BABATSA";
                this.txtArticulo.Text = "unachingoneria de articulo";
            }
        }
    }
}
