...
{
    public partial class frmArticulo : DevComponents.DotNetBar.Office2007Form
    {
        ...
        private void buttonX1_Click_2(object sender, EventArgs e)
        {
            ...
            this.txtCodigo.Text = visitCounter.ToString("0000000"); // Format the counter
        ...
        {
            if (this.txtCodigo.Text == "123")
            {
                MensajeError("Este Articulo ya Existe!!!");
                this.txtNombre.Text = "chingadera";
                this.txtDescripcion.Text = "una chingadera que ya existe";
                this.txtIdcategoria.Text = "no mamar";
                this.txtCategoria.Text = "apoco";
                this.txtIdarticulo.Text = "ajua";
