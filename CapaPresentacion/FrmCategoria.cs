...
namespace CapaPresentacion
{
    public partial class FrmCategoria : Form
    {
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            this.txtIdcategoria.Text = visitCounter.ToString("0000000"); // Format the counter
            this.txtNombre.Focus();
        }
        ...
        private void buttonX1_Click_7(object sender, EventArgs e)
        {
            Reportes.FrmReporteCategoria frm = new Reportes.FrmReporteCategoria();
            frm.Texto = txtBuscar.Text;
            frm.ShowDialog();
        ...
        private void buttonX1_Click_8(object sender, EventArgs e)
        {
            this.BuscarNombre();
        }

        private void buttonX1_Click_9(object sender, EventArgs e)
        {
            try
            {
                DialogResult Opcion;
        ...
        private void buttonX1_Click_10(object sender, EventArgs e)
        {
            Reportes.FrmReporteCategoria frm = new Reportes.FrmReporteCategoria();
            frm.Texto = txtBuscar.Text;
            frm.ShowDialog();
